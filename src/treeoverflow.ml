              ...
              [
                p
                  ...
                  [
                    i []
                      [
                        "An enormous tree with branches stretching \
                         upwards as far as the eye can see. It looks \
                         like some of the branches have been helpfully \
                         labeled, but there's still some deciphering \
                         required to see what's going on... " |> text;
                      ];
                  ];
              ];
            (* title *)
